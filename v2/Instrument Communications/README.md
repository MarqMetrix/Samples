...
**Versions:**
- [2.5.1 Windows 64-bit](https://mqmxresourcedata.blob.core.windows.net/software/Emulator/2.5.1/win-x64/emulator.exe)
- [2.5.1 Windows 32-bit (x86)](https://mqmxresourcedata.blob.core.windows.net/software/Emulator/2.5.1/win-x86/emulator.exe)
